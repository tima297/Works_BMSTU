...
int main() {
    ...
    cout << " Write amount of lines you want to chek " << endl;
    cin >> n;
    for (int i = 0; i < n; i++) {
        for (int j = 0; j < n - 1; j++) {
            if (j % 2 != 0) {
                cout << "Write y" << i + 1 << " of your line " << endl;
                cin >> matrix[i][j];
            }

            else {
                cout << "Write x" << i + 1 << " of your line " << endl;
                cin >> matrix[i][j];
            }
        }
    }
    ...
    if ( S==0)
    cout << "The lines are collimators" << endl;
